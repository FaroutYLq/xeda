try:
	...
	raise ImportError('Please try pytest at the top level directory.')
	print('Please run pytest in the top level directory.')
import os
...
def test_scan():
	...
	run(['python','xeda.py','-t','500GB', '-o', output_dir, '-d', 'dir1', '-s', scan_dir])
