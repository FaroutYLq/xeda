...
dtypes = ["peak_basics", "raw_records_aqmon","distinct_channels", "veto_proximity", "afterpulses",
...
st_midway = cutax.contexts.xenonnt_offline(_rucio_local_path='/project/lgrandi/rucio', include_rucio_local = True)
